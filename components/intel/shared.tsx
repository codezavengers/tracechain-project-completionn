...
const SOURCE_TYPE_LABEL: Record<"RAW_RPC" | "LIVE_API" | "LIVE_INDEXED", string> = {
  RAW_RPC: "Raw RPC",
  LIVE_API: "Live API",
  LIVE_INDEXED: "Indexed",
}

const SOURCE_TYPE_HINT: Record<"RAW_RPC" | "LIVE_API" | "LIVE_INDEXED", string> = {
  RAW_RPC: "Fetched directly from a native chain node — no third-party indexer involved.",
  LIVE_API: "Fetched directly from the chain's own public API.",
  LIVE_INDEXED: "Fetched from a third-party indexer/explorer API, not a raw node.",
}
...
export function SourceTypeBadge({ sourceType }: { sourceType?: "RAW_RPC" | "LIVE_API" | "LIVE_INDEXED" | null }) {
