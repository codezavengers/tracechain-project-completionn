...
export interface Transaction {
  ...
  // (RAW_RPC), an official/native network API (LIVE_API), or a live
  // historical-indexing service used because raw RPC cannot enumerate an
  // address's full history (LIVE_INDEXED). Null only for demo/mock rows.
  sourceType?: "RAW_RPC" | "LIVE_API" | "LIVE_INDEXED" | null
}
...
export interface ProviderHealth {
  ...
  // RAW_RPC | LIVE_API | LIVE_INDEXED — absent when CONFIGURATION_REQUIRED.
  sourceType: "RAW_RPC" | "LIVE_API" | "LIVE_INDEXED" | null
